...
public class HttpClientUtils {
	...
	*/
	...
	public static String postParameters2(String url, Map<String, String> params)
			throws ConnectTimeoutException, SocketTimeoutException, Exception {
		...
		if (params != null) {
            for (Entry<String, String> entry : params.entrySet()) {
                ...
                map2.put(key, objectVal);
            }
        }		
		return postForm(url, map2, null, connTimeout, readTimeout);
	}
	...
	*/
	 ...
	 * @throws Exception
	 */
	public static String post_json(String url, String parameterStr)
			throws ConnectTimeoutException, SocketTimeoutException, Exception {
	 ...
	 */
	public String postJson(String url,String parameters) {  
		int status=0;
        String body = null;  
	...
	*/
	...
	public static String post(String url, Map<String, String> params, boolean isHttps)
		...
		String body = null;
		if (isHttps) {
			HttpsUtil.Do2(url, params, HttpsUtil.POST_Method, HttpsUtil.charset);
		} else {
			HttpClientUtils.postParameters2(url, params);
		}
		return body;
	}
