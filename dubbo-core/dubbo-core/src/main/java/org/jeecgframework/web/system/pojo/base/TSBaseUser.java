...
public class TSBaseUser extends IdEntity implements java.io.Serializable {
	...
	private String deletedFlag="0";//删除标志 1：已删除, 0：未删除
	...
	private String logintoken;//登录口令
...
//	}
	...
	* @return logintoken
	*/ 
	@Column(name ="LOGINTOKEN",nullable=true,length=50)
	public String getLogintoken() {
		return logintoken;
	}
	/**
	* @param logintoken 要设置的 logintoken
	*/ 
